...
export const editProjectPending = () => action(Actions.EDIT_PROJECT_ERROR);
export const editProjectSuccess = (project: Project) =>
  action(Actions.EDIT_PROJECT_SUCCESS, project);
export const editProjectError = (error: string) => action(Actions.DELETE_PROJECT_ERROR, error);
export const deleteProjectPending = () => action(Actions.DELETE_PROJECT_ERROR);
